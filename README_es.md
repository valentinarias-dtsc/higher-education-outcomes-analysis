...
Un proyecto de análisis de extremo a extremo que examina cómo varían los resultados de finalización académica entre materias-comisiones, programas académicos, modalidades de entrega y turnos de clase.
...
> **¿Cómo varían los resultados académicos entre materias-comisiones, programas académicos y contextos instruccionales?**

La Versión 1.0 examina **2024 C1**, un período académico en una institución. La unidad de análisis es la **materia-comisión**: cada observación contiene resultados de matrícula agregados y características operacionales de la institución.
...
- La base analítica final contiene **297 materias-comisiones**, **131 materias** y **13 programas académicos**.
...
El resultado principal es la **tasa de finalización** a nivel de comisión: finalizaciones promovidas más finalizaciones regulares, dividido por inscripción total. El análisis compara esta medida por:
...
- La modalidad de entrega se asoció con finalización, *p* = 0,0267, η² parcial = 0,028. Las comisiones híbridas tuvieron una media menor que las comisiones presenciales; híbrida y en línea no fueron estadísticamente distinguibles.
- El turno se asoció con finalización, *p* = 0,0048, η² parcial = 0,036. Las comisiones de noche tuvieron mayor finalización promedio que las comisiones de mañana y tarde.
...
Las asociaciones estadísticamente significativas tenían tamaños de efecto pequeños. Estos hallazgos son asociaciones a nivel de comisión de un período académico, no conclusiones causales o a nivel de estudiante. Ver el [resumen ejecutivo](reports/executive_summary.md) para consideraciones de generalización e implicaciones.
...
Los conjuntos de datos de demostración preservan la estructura de comisión seudónimizada, inscripción total y campos operacionales mientras reemplazan los conteos de resultados. Hacen que los últimos dos cuadernos sean públicamente ejecutables, pero producen resultados sintéticos, no institucionales.
...
La Versión 1.0 está completa dentro de su alcance declarado de un período de término y a nivel de comisión. Las versiones futuras pueden extenderla con períodos académicos adicionales, modelos multivariables y de interacción, análisis de robustez y estratificación institucional.
